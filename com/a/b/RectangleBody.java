...
public abstract class RectangleBody {
    ...
    protected RectangleBody(Form var1) {
        this.id = field_146.incrementAndGet();
        this.body = new NotReal2DBody(this.id);
        this.body.setUniqueName(this.getClass().getSimpleName() + '#' + this.id);
    ...
    public void method_283(int var1) {
        double var2 = this.body.getSpeed().getSquaredLength();
    ...
    public void method_286(int var1) {
        double var2 = Math.abs(this.body.angularSpeed());
    ...
    public double method_296(RectangleBody var1) {
        return this.method_295(var1.body.getX(), var1.body.getY());
    }

    public final boolean equals(Object var1) {
        return this == var1 || var1 != null && this.getClass() == var1.getClass() && this.id == ((RectangleBody)var1).id;
    }
