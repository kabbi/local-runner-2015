...
public class class_38 extends class_34 {
    public boolean beforeResolvingCollision(class_58 var1) {
        ...
        if(!var2.method_345() && var2.method_334() <= 0 && var3.method_347() > 0 && var2.method_296(var3) <= class_85.method_500(var3.method_279().getForm())) {
            ...
            var4.setSomeOtherMovementFrictionFactor(0.001D);
            var4.setRotationFrictionFactor(0.0017453292519943296D);
            var4.setAngularVelocity(var4.getAngularVelocity() + (RandomUtils.randomBoolean() ? 0.0023271056693257726D : -0.0023271056693257726D) * var4.getVelocity().getLength());
            return false;
        } else {
            return false;
        }
