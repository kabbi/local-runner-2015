    ...
    public boolean beforeResolvingCollision(class_58 var1) {
        ...
        if(var3 > 0.0D) {
            ...
            if(var5 > 0.01D) {
                ...
                var1.method_361().method_20(new class_124(EffectType.CAR_AND_BORDER_IMPACT, ((Integer)this.field_145.get()).intValue(), var1.method_364().getX(), var1.method_364().getY(), 0.0D));
            }
        }
