...
public class TheSenderOfThings extends class_193 {
    ...
    private final class_193.class_210 field_823 = new class_193.class_210<Player>() {
        ...
        public void method_12(Player var1) {
            TheSenderOfThings.this.method_1040(var1);
        }
    };
    ...
    private final class_193.class_210 field_824 = new class_193.class_210<Car>() {
        ...
        public void method_12(Car var1) {
            TheSenderOfThings.this.method_1042(var1);
        }
    };
    ...
    private final class_193.class_210 field_825 = new class_193.class_210<Projectile>() {
        ...
        public void method_12(Projectile var1) {
            TheSenderOfThings.this.method_1044(var1);
        }
    };
    ...
    private final class_193.class_210 field_826 = new class_193.class_210<Bonus>() {
        ...
        public void method_12(Bonus var1) {
            TheSenderOfThings.this.method_1046(var1);
        }
    };
    ...
    private final class_193.class_210 field_827 = new class_193.class_210<OilSlick>() {
        ...
        public void method_12(OilSlick var1) {
            TheSenderOfThings.this.method_1048(var1);
        }
    };
    // $FF: renamed from: f int
    private int field_828;

    public TheSenderOfThings(GameParatemers var1, File var2) {
        super(var1, var2);
    }

    // $FF: renamed from: b () java.lang.String
    public String method_58() {
        method_1052((TheSenderOfThings.class_224)this.a(TheSenderOfThings.class_224.class), TheSenderOfThings.class_224.field_773);
        return this.method_1024();
    }

    // $FF: renamed from: b (int) void
    public void method_59(int var1) {
        this.a(TheSenderOfThings.class_224.field_774);
        this.c(var1);
        this.method_1036();
    }
    ...
    public int method_60() {
        method_1052((TheSenderOfThings.class_224)this.a(TheSenderOfThings.class_224.class), TheSenderOfThings.class_224.field_775);
        return this.field_828 = this.method_1028();
    }

    // $FF: renamed from: a (com.a.b.a.a.c.l) void
    public void sendThings(Game var1) {
        this.a(TheSenderOfThings.class_224.field_776);
        if(var1 == null) {
            this.a(false);
        } else {
            this.a(true);
    ...
    public void method_62(class_146 var1, boolean var2) {
        this.a(TheSenderOfThings.class_224.field_777);
        if(var1 == null) {
            this.a(false);
        } else {
            this.a(true);
    ...
    public Move[] method_63() {
        method_1052((TheSenderOfThings.class_224)this.a(TheSenderOfThings.class_224.class), TheSenderOfThings.class_224.field_778);
    ...
    public void method_64() {
        try {
            this.a(TheSenderOfThings.class_224.field_772);
            this.method_1036();
    ...
    private static void method_1052(TheSenderOfThings.class_224 var0, TheSenderOfThings.class_224 var1) {
        if(var0 != var1) {
